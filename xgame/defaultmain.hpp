...
struct GameDaemonConfiguration
{
   ...
   * to it, so that multiple libxgame-based games can be in the same base
   * data directory.
   */
 ...
 *
 * This can be used to create game daemons even simpler than with libxgame
