...
public:
   ...
   * (depending on GetXRpc) will be disabled.
   *
 ...
 * of an actual game so that it can be plugged into libxgame to form
 ...
 * with the state that libxgame keeps, games should leverage the transactions
 ...
 * and the libxgame-stored data, and allows atomic transactions spanning
 * both of them.
 */
