 ...
 * https://github.com/spacexpanse/libxgame/issues/86.
 */
...
private:
  ...
  MockXRpcServer mockXServer;
  XRpcClient rpcClient;
...
protected:
  ...
  SQLitePendingMoveTests ()
    : httpServer(MockXRpcServer::HTTP_PORT),
      httpClient(MockXRpcServer::HTTP_URL),
      mockXServer(httpServer),
